...
//**********************************MAIN MENU********************************
    ...
    $('.accordion').on('show', function(e) {
        console.log();
        localStorage.setItem("accIndex", e.target.id);
    ...
    var accIndex = localStorage.getItem('accIndex');

    if (accIndex) {
        console.log(accIndex);
        $('a[href="#' + accIndex + '"]').removeClass('collapsed');
        $('#'+accIndex).removeClass('collapse');
        $('#'+accIndex).addClass('in collapse');
        $('#'+accIndex).attr('style', 'height:auto;');        
    }
